;(function ($) {
  var allfunction = {
      ...
      $('.menu-bar ul li').each(function () {
        if ($(this).children('ul').length) {
          $(this)
            .children('a')
            .append(
              '<i class= "icofont-thin-down icon-hidden-md"></i><div class="drop-icon"><span class="icofont-minus"></span><span class="icofont-plus"></span></div>'
            )
        }
      })
    ...
    stopPropagationElements: () => {
      $(
        '.search-box input , .input-group-icon input, .sign-in-card , .menu-bar'
      ).on('click', function (e) {
        e.stopPropagation()
      })
    },
